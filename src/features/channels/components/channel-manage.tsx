...
/**
 * Channels — THE CHANNEL-MANAGEMENT SURFACE, carried over WHOLESALE at the
 ...
 *
 * ⚠ SPLIT OUT OF `channels-core.tsx` RATHER THAN INLINED — the core is the
 ...
 *
 * ⚠ Next-free like the rest of the v2 tree. `ChannelsCreateDialogs` takes no
 ...
 */
export function ChannelsManageActions({
  channel,
  workspaceId,
  workspaceSlug,
  currentUserId,
 ...
 */
export function ChannelsCreateDialogs({
  workspaceId,
  workspaceSlug,
  currentUserId,
  createOpen,
