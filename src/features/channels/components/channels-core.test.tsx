...
/**
 * Channels core — THE ROUTE-DRIVEN SELECTION (wiring plan Phase 9).
 *
...
describe("ChannelsCore — the channel a caller names", () => {
...
describe("ChannelsCore — the thread a pop-out names", () => {
