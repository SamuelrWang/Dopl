 ...
 * full channels experience (header, transcript, composer, the Info / Threads /
 ...
 * This file is the second host of that hook; `channels-core.tsx` is the first.
 * **There is no third code path for the live loop.**
 *
 * ⚠ SELECTION IS LOCAL AND THREAD-ONLY. `use-channels-selection.ts` carries
