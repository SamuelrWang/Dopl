 ...
 * use → containment → messaging; the runtime decides the vocabulary of the rows under it.
 * No model row: main resolves a launch's model (`main/runtime/launch-default.js`); the record stores none.
 */
