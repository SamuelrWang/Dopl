 ...
 * register the realtime doorbell through the same `useChannelsLive` the
...
vi.mock("./composer", () => ({
  ChannelsComposer: ({ liveAgents = [] }: { liveAgents?: readonly { name: string }[] }) => (
...
import { ChannelsThreadWindow, threadWindowTitle } from "./thread-window";
