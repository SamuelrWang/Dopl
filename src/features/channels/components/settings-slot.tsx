...
/**
 * Channels — WHICH MANAGE SURFACE THE SETTINGS TAB HOSTS (Samuel, 2026-08-21).
 *
...
import { ChannelsThreadManageActions } from "./thread-manage";
import type { Channel, ChannelMember, ChannelThread } from "../types";

export function ChannelsSettingsSlot({
  channel,
  workspaceId,
  workspaceSlug,
  currentUserId,
