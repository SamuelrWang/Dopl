 ...
 * (`agent-panel-controls.tsx › AgentControls`, `agent-window.tsx › ChannelsAgentWindow`).
 * ⚠ **ONLY THIS CARD CROSSED**: Pause / End stay panel-only, because a destructive verb in a
 * window that never had one is a new control rather than a move.
 *
