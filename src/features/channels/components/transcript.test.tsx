...
describe("channels transcript — sides", () => {
...
describe("channels transcript — channel view vs thread view", () => {
 ...
 */
describe("channels transcript — lifecycle receipts", () => {
...
describe("channels transcript — what it refuses to render", () => {
 ...
 */
describe("channels transcript — the request fan-out", () => {
  const GROUP = "grp-1";
