...
/** Cold arrival: ⚠ the console must load into the shared two-pane skeleton,
 *  not render real panes with `members = []` and claim "No members yet." in a
 *  workspace that always contains at least the reader. */
/** Reads are mocked, but the console's WRITES are real mutation hooks taking
 *  their client from context — the provider is part of mounting this at all. */
function render() {
