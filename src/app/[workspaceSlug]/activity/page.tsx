/**
 * /[workspaceSlug]/activity — placeholder. Audit log + recent events
 * UX is a separate slice of work; this route exists so the sidebar nav
 * resolves cleanly.
 */
  ...
  return (
    <div className="container mx-auto px-4 pt-24 pb-16 max-w-3xl">
      ...
      <p className="mt-2 text-sm text-white/50">
        Activity log for <span className="font-mono">{workspace.name}</span>{" "}
        — coming soon.
      </p>
    </div>
  );
