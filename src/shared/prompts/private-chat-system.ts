...
1. Use multiple read tools across families (search_workspace_knowledge, read_knowledge_entry, list_workspace_skills, read_skill_file, list_workspace_clusters) to assemble the relevant material. Cross-source freely; the user wants curation, not a single search dump.
