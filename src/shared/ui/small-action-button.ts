 ...
 * Discard (`channels-v2/composer-toolbar.tsx`), every popup form's Discard
 * (`shared/ui/form-dialog.tsx`), and the panel card action (`channels-v2/bits.tsx ›
 ...
 * (`channels-v2/bits.tsx › TAB_ACTION`).
 */
