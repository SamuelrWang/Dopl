 ...
 * perfect rendering at any size via `currentColor` + class-based
 * sizing. Pass a `className` to size / color it.
 */

import type { ComponentProps } from "react";

interface PlatformIconProps extends Omit<ComponentProps<"svg">, "children"> {
