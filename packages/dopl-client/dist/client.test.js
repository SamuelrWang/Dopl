 ...
 */
(0, vitest_1.describe)("updateAgentIdentity — optimistic concurrency", () => {
    let mock;
    ...
    (0, vitest_1.it)("OMITTING it is refused BEFORE the wire, naming what to pass", async () => {
        await (0, vitest_1.expect)(client().updateAgentIdentity(TPL, { name: "Renamed" })).rejects.toBeInstanceOf(errors_js_1.DoplApiError);
