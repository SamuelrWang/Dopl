 ...
 */
export declare function listChannelAgents(t: DoplTransport, channelId: string): Promise<ChannelAgent[]>;
/**
 ...
 */
export declare function addThreadParticipant(t: DoplTransport, channelId: string, threadId: string, identity: ThreadParticipantRef): Promise<ThreadParticipant>;
/**
 ...
 */
export declare function removeThreadParticipant(t: DoplTransport, channelId: string, threadId: string, identity: ThreadParticipantRef): Promise<void>;
