...
export declare function listChatsTrash(t: DoplTransport): Promise<TrashedChat[]>;
...
export declare function restoreChat(t: DoplTransport, chatId: string): Promise<Chat>;
