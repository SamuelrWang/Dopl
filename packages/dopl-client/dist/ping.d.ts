 ...
 */
export declare function createPing(t: DoplTransport, input: CreatePingInput): Promise<ChannelPing>;
/**
 ...
 */
export declare function listPings(t: DoplTransport, opts?: ListPingsOptions): Promise<ChannelPing[]>;
/**
 ...
 */
export declare function awaitPings(t: DoplTransport, opts: AwaitPingsOptions): Promise<PingAwaitResult>;
