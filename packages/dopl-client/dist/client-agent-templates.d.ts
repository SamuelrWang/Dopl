...
export declare class AgentTemplateMethods extends SkillMethods {
    ...
    updateAgentTemplate(templateId: string, patch: AgentTemplateUpdateInput, expectedVersion?: string | null): Promise<AgentTemplate>;
}
