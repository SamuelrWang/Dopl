...
const SCHEMA_CEILINGS: Record<string, number> = {
  ...
  dopl_channel: 9411, // +7: `wait_ms` publishes the manage clamp (P8-18), `color` is a marker (P8-15). Re-derive, never quote.
 ...
 * claims a win.
 */
const SERVED_TOTAL_CEILING = 49_202; // re-derive, never quote: −3 the 2026-09-23 vocabulary removal (dopl_ontology row), −229 home-channel addressing pulled (P8-23), +15 caller's own tool loader (X-09), +9 P8-15/P8-18.
/**
