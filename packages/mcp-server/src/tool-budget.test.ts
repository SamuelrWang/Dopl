...
const SCHEMA_CEILINGS: Record<string, number> = {
  ...
  dopl_channel: 9342, // −63 (2026-09-25): `posture.tools` is a permission level; the per-runtime word list moved to the pulled doctrine (+58 there). −6: rooms.update rename+describe (DMP-001) paid for by trimming the info_card describe. +7: `wait_ms` publishes the manage clamp (P8-18), `color` is a marker (P8-15). Re-derive, never quote.
...
const GRANULAR_DOCTRINE_CEILING = 14_558; // +58 pulled against −126 pushed (2026-09-25): permission levels.
const DOCTRINE_CEILING = 14_306; // +58 pulled against −63 pushed (2026-09-25): the runtime words behind the permission levels. +312 pulled against −229 pushed: home-channel addressing moved into `rooms` (P8-23); +16 P8-20. Re-derive, never quote.
