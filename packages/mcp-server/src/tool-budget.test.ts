 ...
 * claims a win.
 */
const SERVED_TOTAL_CEILING = 49_199; // re-derive, never quote: −6 DMP-001 net, −229 home-channel addressing pulled (P8-23), +15 caller's own tool loader (X-09), +9 P8-15/P8-18.
/**
