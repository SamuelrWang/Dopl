...
export function registerSkillTools(
  ...
  register(
    ...
    SKILL_DESCRIPTION,
    {
      ...
      expected_version: z.string().optional().describe("op=write: the Version from a prior read, to avoid overwriting a concurrent edit (412 on mismatch). Omit to auto-guard against the current version."),
