  ...
  if (measured > LAUNCH_GOAL_MAX_CHARS) {
    return err(
      [
        ...
        `**Nothing was filed**: your \`body\` is ${measured} characters and a launch goal caps at ${LAUNCH_GOAL_MAX_CHARS}. The 16000 the schema publishes is op="send"'s; this lane is tighter.`,
