...
describe("THE LAW is stated, in full, in the tool description", () => {
  ...
  it("states the one rule: NOTHING ACTS UNLESS ADDRESSED", () => {
    expect(DESCRIPTION).toContain("NOTHING ACTS UNLESS ADDRESSED");
  ...
  it("says `as_agent` is REQUIRED to post into a breakout thread you are in as an agent", () => {
  ...
  it("keeps the law SHORT — it is read on every connection", () => {
