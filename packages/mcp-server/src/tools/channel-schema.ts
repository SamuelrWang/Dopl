...
export const CHANNEL_INPUT_SHAPE = {
  ...
  // (`channel-directive-hold.ts › DIRECTIVE_WAIT_CAP_MS`).
  wait_ms: z.coerce
    .number()
    .int()
    .min(0)
