...
const KB_INPUT_SHAPE = {
  ...
  expected_version: z.string().optional().describe("write_file: the entry's Version from a prior read_file — required when overwriting (412 without it); creates need none."),
