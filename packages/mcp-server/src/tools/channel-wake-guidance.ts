 ...
 */
export function waitingLine(call: string, cursor: number): string {
  return `cursor=${cursor} · hold, never poll: ${call} · ${DOCTRINE_URI} › Waiting`;
}
 ...
 */
export const WAITING_LINE_MAX_CHARS = 160;
