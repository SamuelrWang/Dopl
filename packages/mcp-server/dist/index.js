...
async function main() {
    ...
    const client = new client_1.DoplClient(baseUrl, apiKey, { clientIdentifier: version_js_1.clientIdentifier });
    ...
    const server = (0, server_js_1.createServer)(client, { isAdmin: is_admin });
