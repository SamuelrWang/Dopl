...
exports.CHANNEL_DESCRIPTION = exports.HOME_CHANNEL_ADDRESSING = exports.TENANCY_FIX = exports.TENANCY_RULE = exports.DESCRIPTION_MAX_CHARS = void 0;
...
exports.CHANNEL_DESCRIPTION = `Cross-user collaboration channels: you, other members, and their agents.
...
READ op="help" FIRST (same text as the MCP resource ${channel_doctrine_1.DOCTRINE_URI}) for the law of a channel, the thread/session model, the await loop and its stop rule, @-tagging, and your own agents. Results report only what the call DID.
