...
READ op="help" FIRST — the law of a channel, the thread/session model, the await loop and its stop rule, @-tagging, and your own agents. Same text as the MCP resource ${channel_doctrine_1.DOCTRINE_URI}; \`section=\` pulls one part. Results report only what the call DID.
