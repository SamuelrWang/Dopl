 ...
 */
function registerChannelTool(register, client, selfUserId = null) {
    register("dopl_channel", CHANNEL_DESCRIPTION, {
        ...
        channel: zod_1.z
            .string()
            .optional()
            .describe('Channel slug or id. Required for invite/post/read/await/members/list_threads/get_thread/create_thread/close_thread/set_thread_mode. (op="open" creates a new channel and needs no channel; op="list" lists them all.)'),
        direct: zod_1.z
            .boolean()
            .optional()
        ...
        switch (args.op) {
            ...
            case "await": {
                ...
                if (miss)
                    return miss;
                return (0, channel_ops_read_1.opAwait)(client, args.channel, args.since, args.timeout_ms, selfUserId);
            }
            case "members": {
            ...
            case "create_thread": {
                ...
                if (miss)
                    return miss;
                return (0, channel_ops_threads_1.opCreateThread)(client, args.channel, args.title, args.body, args.to, args.mode, args.client_msg_id);
            }
            case "close_thread": {
