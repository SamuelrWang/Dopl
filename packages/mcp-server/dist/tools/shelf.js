...
exports.SHELF_ARG_DESCRIPTION = exports.SHELF_ABSENT_RULE = exports.SHELF_VALUES = void 0;
exports.toWireShelf = toWireShelf;
exports.toWireShelfOrUndefined = toWireShelfOrUndefined;
exports.homeShelfForbidden = homeShelfForbidden;
/** The two values the tool arg accepts. ⚠ Operator vocabulary, not wire. */
exports.SHELF_VALUES = ["personal", "workspace"];
/**
 ...
 */
exports.SHELF_ABSENT_RULE = `\`shelf\` absent means BOTH shelves on a READ and the WORKSPACE shelf on a WRITE — the two directions differ on purpose, so do not carry the read rule to a create.`;
/**
 ...
 */
exports.SHELF_ARG_DESCRIPTION = `Which SHELF to target: "personal" = your own /home shelf (the private rows inside your DEFAULT workspace), "workspace" = the workspace's shared shelf. ${exports.SHELF_ABSENT_RULE} This is NOT how you reach a home CHANNEL — a home channel is a workspace, addressed with \`workspace=<container id>\`.`;
/**
 ...
 */
function homeShelfForbidden(e) {
    if (typeof e !== "object" || e === null)
        return null;
    if (e.status !== 403)
        return null;
    const code = e.code;
    if (code !== "HOME_SCOPE_FORBIDDEN" &&
