...
export declare const SHELF_VALUES: readonly ["personal", "workspace"];
 ...
 */
export declare function toWireShelf(shelf: ShelfArg): KbShelf & TemplateShelf;
/** `toWireShelf`, tolerating the absent case — undefined means NO FILTER. */
export declare function toWireShelfOrUndefined(shelf: ShelfArg | undefined): (KbShelf & TemplateShelf) | undefined;
/**
 ...
 */
export declare const SHELF_ABSENT_RULE = "`shelf` absent means BOTH shelves on a READ and the WORKSPACE shelf on a WRITE \u2014 the two directions differ on purpose, so do not carry the read rule to a create.";
/**
 ...
 */
export declare const SHELF_ARG_DESCRIPTION = "Which SHELF to target: \"personal\" = your own /home shelf (the private rows inside your DEFAULT workspace), \"workspace\" = the workspace's shared shelf. `shelf` absent means BOTH shelves on a READ and the WORKSPACE shelf on a WRITE \u2014 the two directions differ on purpose, so do not carry the read rule to a create. This is NOT how you reach a home CHANNEL \u2014 a home channel is a workspace, addressed with `workspace=<container id>`.";
/**
 ...
 */
export declare function homeShelfForbidden(e: unknown): string | null;
