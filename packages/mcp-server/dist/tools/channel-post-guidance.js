...
exports.postMentionFacts = postMentionFacts;
 ...
 * no `@` at all.
 */
function postMentionFacts(body, message) {
    ...
    return {
        tags: (0, channel_facts_1.tagFact)(resolvedMentionCount(message), handles.length),
