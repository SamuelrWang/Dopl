...
async function opList(client) {
    ...
    return (0, respond_1.ok)(anyWorkflows ? [...lines, "", WORKFLOW_SCOPE_NOTE].join("\n") : lines.join("\n"));
}
async function opGet(client, slug) {
    ...
    if (workflows.length === 0) {
        ...
        lines.push("_No workflows in this cluster that you can read. Team-scoped workflows you hold no grant on, and trashed ones, are not listed._");
    }
    else {
