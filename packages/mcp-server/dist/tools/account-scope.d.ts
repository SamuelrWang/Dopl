 ...
 */
import type { AccountMessagesOptions, AccountMessagesPage, AccountStatus, AccountStatusOptions, DoplClient } from "@dopl/client";
 ...
 */
export declare function accountStatus(client: DoplClient, directory: WorkspaceDirectory, opts?: AccountStatusOptions): Promise<AccountStatus>;
/**
 ...
 */
export declare function accountMessages(client: DoplClient, directory: WorkspaceDirectory, opts: AccountMessagesOptions): Promise<AccountMessagesPage>;
