 ...
 */
exports.HOLD_DEFAULT_MS = 215_000;
/**
 ...
 */
exports.HOLD_EXTERNAL_MARGIN_MS = 15_000;
/**
 ...
 */
exports.HOLD_EXTERNAL_DEFAULT_MS = exports.EXTERNAL_CLIENT_ABORT_MS - exports.HOLD_EXTERNAL_MARGIN_MS;
/**
 ...
 */
function resolveHoldMs(raw) {
    const text = (raw ?? "").trim();
    if (!/^\d+$/.test(text))
        return exports.HOLD_DEFAULT_MS;
    const ms = Number.parseInt(text, 10);
    if (!Number.isFinite(ms))
        return exports.HOLD_DEFAULT_MS;
    return Math.min(exports.HOLD_CAP_MS, Math.max(HOLD_FLOOR_MS, ms));
}
/**
 ...
 * route around it.
 */
function resolveHoldCeilingMs(raw) {
...
exports.HOLD_MIN_POLL_MS = 1_000;
/**
 ...
 */
exports.HOLD_MAX_POLLS = Math.ceil(ENV_CEILING_MS / exports.HOLD_POLL_MS) + 2;
/**
 ...
 */
function holdMsFor(timeoutMs, runtime) {
