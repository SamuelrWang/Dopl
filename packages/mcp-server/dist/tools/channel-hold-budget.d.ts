 ...
 */
export declare const HOLD_CAP_MS = 230000;
/**
 ...
 */
export declare const HOLD_DEFAULT_MS = 215000;
/**
 ...
 */
export declare const HOLD_EXTERNAL_MARGIN_MS = 15000;
/**
 ...
 */
export declare const HOLD_EXTERNAL_DEFAULT_MS: number;
/**
 ...
 */
export declare const HOLD_MARGIN_MS = 60000;
/**
 ...
 * double-count.
 */
export declare const HOLD_POLL_MS = 50000;
/**
 ...
 */
export declare function resolveHoldMs(raw: string | undefined): number;
/**
 ...
 * route around it.
 */
export declare function resolveHoldCeilingMs(raw: string | undefined): number;
/** Don't re-issue an inner poll for a sliver of the remaining budget. */
export declare const HOLD_MIN_POLL_MS = 1000;
/**
 ...
 */
export declare const HOLD_MAX_POLLS: number;
/**
 ...
 * about getting one.
 */
export declare const HOLD_SHORT_MS = 60000;
/**
 ...
 */
export declare function holdMsFor(timeoutMs: number | undefined, runtime: string | null): number;
/**
 ...
 */
export declare const DESKTOP_HOLD_REFUSAL = "await is not available in a desktop-run session: end your turn; you are woken when addressed.";
