...
export declare function opCreateFolder(client: DoplClient, ref: string, path: string): Promise<ToolResponse>;
export declare function opMoveFolder(client: DoplClient, ref: string, from_path: string, to_path: string): Promise<ToolResponse>;
export declare function opWriteFile(client: DoplClient, ref: string, path: string, body: string, title?: string, expected_version?: string, force?: boolean): Promise<ToolResponse>;
