 ...
 * in an unframed line.
 */
export declare function describeFailure(e: unknown): string;
 ...
 */
export declare function runHold<M extends ChannelMessage>(poll: HoldPoll<M>, since: number, timeoutMs: number | undefined, runtime: string | null, selfSessionId: string | null): Promise<HoldOutcome<M>>;
/**
 ...
 */
export declare function wasCutShort(elapsedMs: number, budgetMs: number): boolean;
