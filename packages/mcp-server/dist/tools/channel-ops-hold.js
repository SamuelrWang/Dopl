 ...
 */
async function opHold(client, ref, since, waitMs, selfUserId = null, runtime = null, selfSessionId = null) {
    let held;
    try {
        held = await (0, channel_hold_loop_1.runHold)(
        ...
        (args) => client.awaitChannelMessages(ref, args), since, waitMs, runtime, selfSessionId);
    }
    catch (e) {
    ...
    if (messages.length === 0) {
        ...
        return (0, respond_1.ok)([
            timedOut,
            ...(0, channel_wake_guidance_1.holdTimedOutLines)(ref, cursor, runtime),
