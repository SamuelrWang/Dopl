 ...
 */
export declare const POLL_STRIKE_LIMIT = 3;
/** @see POLL_STRIKE_LIMIT — hand-copied from the same file, pinned by the same test. */
export declare const POLL_STRIKE_WINDOW_MS: number;
/**
 ...
 */
export declare function pollSubject(caller: CallerIdentity): string | null;
/**
 ...
 */
export declare function noteHold(subject: string | null, scope: string): void;
/**
 ...
 */
export declare function notePollingRead(subject: string | null, scope: string, since: number | undefined, now?: number): boolean;
/**
 ...
 */
export declare function pollingDetectedLine(retry: string, cursor: number | undefined): string;
/**
 ...
 */
export declare function resetPollDetectorForTests(): void;
