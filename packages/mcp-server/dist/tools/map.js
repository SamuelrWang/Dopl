...
directory, caller = identity_1.UNKNOWN_CALLER) {
    register("dopl_map", MAP_DESCRIPTION, {}, async () => {
        ...
        for (const [heading, ontologies] of (0, ontology_render_1.homeSpaceShelfGroups)(ontology.ontologies, ontology.homeSpaceOntologyIds)) {
        ...
        if (ontology.ontologies.length === 0)
            lines.push("_None._");
