 ...
 */
export declare const TENANCY_FIX = "Re-issue with its ID, which resolves wherever the row lives (dopl_agent lists them); lend it into this channel's container (dopl_agent op=\"grant\", scope=\"container\", to=<that container>) or create it there \u2014 or launch without an identity.";
