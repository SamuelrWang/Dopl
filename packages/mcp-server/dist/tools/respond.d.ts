 ...
 * The pin verbs raise it today; the delete routes, `channel-grants` and the
 * template delete carry the same wrapper option, so the next op that grows an
 * arm gets this sentence rather than a second wording of it.
