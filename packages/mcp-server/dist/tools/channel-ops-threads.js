...
async function opCloseThread(client, channelRef, threadId, outcome, summary) {
    ...
    try {
        ...
        if ((0, channel_errors_1.isForbidden)(e)) {
            return (0, respond_1.err)(`You can't close thread ${safeId} — only its creator or the member it's addressed to may close it.`);
        }
        throw e;
    }
