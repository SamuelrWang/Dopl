...
export declare function opReadFile(client: DoplClient, ref: string, path: string): Promise<ToolResponse>;
export declare function opListTrash(client: DoplClient, ref?: string): Promise<ToolResponse>;
