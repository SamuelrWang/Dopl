 ...
 * back to the prose.
 */
function escalationBody(e) {
    const lines = [`**Escalation:** ${e.issue}`];
    if (e.context)
    ...
    if (e.recommendation) {
        ...
        lines.push("", `**Recommended:** ${e.recommendation.index + 1}. ${pick.label} — ${e.recommendation.why}`);
    }
    return lines.join("\n");
}
/**
 ...
 */
exports.ESCALATION_BODY_PARITY_CASES = [
    {
