...
export declare const DIRECTIVE_WAIT_DEFAULT_MS = 15000;
export declare const DIRECTIVE_WAIT_CAP_MS = 30000;
/** Coarse on purpose: the far end is a human-scale toggle plus a spawn or a turn on a machine. */
export declare const DIRECTIVE_POLL_INTERVAL_MS = 1500;
/**
 ...
 */
export declare function holdRow<T extends {
    id: string;
    status: string;
}>(row: T, fetchRow: (id: string) => Promise<T>, waitMs: number | undefined): Promise<T>;
/**
 ...
 */
export declare const LAUNCH_RETRY_ADVICE: Record<LaunchRefusalReason, "once" | "no">;
