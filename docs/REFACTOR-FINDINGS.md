...
## F-212 — `prompt-framing.test.mjs` is 7 lines from the desktop's hard cap, and the desktop has zero exemptions (2026-08-18)
...
## F-213 — `CHANNEL_DESCRIPTION` has a hard budget for its LAW block and none at all for the other 90% (2026-08-18)
