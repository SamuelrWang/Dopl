...
- **IDs: nothing reassigned, nothing reused. F-160, F-161 and F-162 remain permanently unused. The next free id is still F-193** — this pass allocated none, because it found no debt that did not already have an owner.
