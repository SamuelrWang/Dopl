...
- **F-199 through F-201 assigned 2026-08-18**, from Phase 0 of `docs/CHANNELS-V2-WIRING-PLAN.md` (truth-up) — two SPA docblocks that were overtaken by commits the same night and never revisited, plus the sidebar consent poll whose only justification was one of them. **The next free id is F-202.**
