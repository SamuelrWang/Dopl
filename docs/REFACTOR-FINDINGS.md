...
- **F-202 and F-203 assigned 2026-08-18**, from Phase 1 (the read model) — the second SQL expression of the thread activity clock that the new view creates, and the tracked `packages/*/dist` that a plain rebuild proved stale. **The next free id is F-204.**
