...
| `apps/desktop-ui/src/pages/home/agent-card-knowledge.tsx` | INPUT FORM | **Done** (2026-09-22 — born on the kit) |
...
- **Section**: 🔒 ⚠ **THERE IS ONE SECTION PATTERN ON THE DESKTOP AND IT IS FLAT
  ...
  - **Pinned two ways**, and both must move together with any change here:
    `features/agent-templates/components/template-editor-surface.test.tsx ›
