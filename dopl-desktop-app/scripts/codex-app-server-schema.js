...
// installed CLI rejects. A hand-written fixture would rebuild that trap, so only a real handshake
// writes it.
//
...
//
// ⚠ **WHAT IT STORES IS WHAT THE CONTRACT SUITE READS** (`fixtureFrom`): provenance, the
// `initialize` SHAPE (key names and value types), the declared method names and Dopl's own
// requirement. The model catalog and the full schema are measured for the advice printed at the
// end, not stored. Prompts, tokens and auth material never enter it: nothing here sends a turn.
//
