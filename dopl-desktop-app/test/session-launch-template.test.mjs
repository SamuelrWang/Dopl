...
const RESOLVED = {
  ...
  knowledge: [{ baseId: "kb-1", baseName: "Handbook", scope: "base", path: "Handbook" }],
...
test("`context.template` rides the funnel's LITERAL WHITELIST and survives park/resume", () => {
  ...
  assert.match(read("session-seed.js"), /context: \{ \.\.\.\(\(s && s\.context\) \|\| \{\}\), profile: s\.profile, mcpDiscovery: discoveryVerb\(s\) \}/,
    "…and the SESSION's runtime discovery verb (CXP-3A)");
});
