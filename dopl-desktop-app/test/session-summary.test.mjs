...
//
// SOURCE EXTRACTION with INJECTION (the session-reopen idiom): the module's two requires
// (`./agent-names`, `./diag`) sit ABOVE the BEGIN sentinel, so everything from there to
// `module.exports` is require-free and can be evaluated verbatim with fakes. The REAL
// `pickAgentName` is injected from the REAL module — the naming cases are about this file's
// ledger, not about re-testing the pool.
//
...
const SRC = readFileSync(join(MAIN, "session-summary.js"), "utf8");
