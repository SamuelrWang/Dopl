 ...
 *
 * `credits.used` (320) is deliberately NOT `HOME_SERIES`'s sum (210): the bar prints the wallet
 * counter, and fixtures that agreed could not tell it from the ledger sum.
 *
